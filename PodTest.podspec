...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wanpeiqiang/PodTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wanpeiqiang' => '937448209@qq.com' }
  s.source           = { :git => 'https://github.com/wanpeiqiang/PodTest.git', :tag => s.version.to_s }
